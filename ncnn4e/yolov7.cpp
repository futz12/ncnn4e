...
extern "C" __declspec(dllexport) __yolov7 __stdcall yolov7_Init(const unsigned char *mem_param, int size_param, const unsigned char *mem_model, int size_model, const char *inputlayer, const char *outputlayer0, const char *outputlayer1, const char *outputlayer2, const bool use_vulkan)
{
